...
plt.subplot( 2, 2, 2); plt.contourf(xi, yi, Qmap, np.linspace(-0.2, 0.2, 21), cmap=plt.cm.jet); plt.colorbar(); plt.title(prefix + '-StokesQ')
circle_x, circle_y = circlePoints(0, 0, FWHM/2); plt.plot( circle_x, circle_y )
circle_x, circle_y = circlePoints(0, 0, FWHM/sqrt(2));   plt.plot( circle_x, circle_y )
plt.subplot( 2, 2, 3); plt.contourf(xi, yi, Umap, np.linspace(-0.2, 0.2, 21), cmap=plt.cm.jet); plt.colorbar(); plt.title(prefix + '-StokesU')
circle_x, circle_y = circlePoints(0, 0, FWHM/2); plt.plot( circle_x, circle_y )
circle_x, circle_y = circlePoints(0, 0, FWHM/sqrt(2));   plt.plot( circle_x, circle_y )
